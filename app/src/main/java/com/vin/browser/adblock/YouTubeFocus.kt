...
data class YouTubeFocusSettings(
    ...
    companion object {
        ...
        fun hasActiveFeature(s: YouTubeFocusSettings) = s.hideShorts || s.hideRecommendations || s.hideComments || s.hideEndScreenSuggestions || s.disableAutoplay
    }
}
...
object YouTubeFocus {
    ...
    fun inject(view: WebView, settings: YouTubeFocusSettings = YouTubeFocusSettings.default()) {
        // Only inject CSS + watchdog when at least one feature is active
    ...
    private fun buildScript(s: YouTubeFocusSettings): String {
        ...
        return """
            (function() {
              ...
              // Fast video ad auto-skip watchdog
              try {
